...
N 480 -150 480 -100 { lab=Vb4_}
N 580 -150 580 -100 { lab=Vb4}
N 390 -230 390 -210 { lab=Vb4_}
N 390 -120 390 -60 { lab=GND}
...
C {devices/gnd.sym} 390 -90 3 0 {name=l22 lab=GND}
...
C {sky130_fd_pr/nfet_01v8.sym} 410 -260 0 1 {name=M1
L=.45
W=4
nf=1
mult=1
...
C {devices/gnd.sym} 430 -260 3 0 {name=l14 lab=GND}
C {devices/gnd.sym} 390 -290 2 0 {name=l26 lab=GND}
C {sky130_fd_pr/nfet_01v8.sym} 410 -30 0 1 {name=M2
L=.45
W=4
nf=1
mult=1
...
C {devices/gnd.sym} 390 0 0 0 {name=l27 lab=GND}
C {devices/gnd.sym} 430 -30 3 1 {name=l28 lab=GND}
