...
N 880 -410 1050 -410 { lab=Vout}
N 960 -430 960 -410 { lab=Vout}
N 790 -410 880 -410 { lab=Vout}
...
.include /home/jared/Documents/GS_Design/tia_post_approval/pex/mirror_1_pex_fixed.spice
"}
C {devices/launcher.sym} 810 -610 0 0 {name=h1
descr='tate
tclcommand="ngspice::annotate"}
C {devices/ngspice_probe.sym} 450 -810 0 0 {name=r1}
C {devices/ammeter.sym} 450 -860 2 0 {name=Vmeas current=3.7613e-05}
...
.endc
"}
C {devices/lab_wire.sym} 1050 -410 0 1 {name=l73 sig_type=std_logic lab=Vout}
C {devices/capa.sym} 960 -460 0 0 {name=C6
m=1
value=50f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 960 -490 2 0 {name=l80 lab=GND}
...
C {devices/gnd.sym} 790 -370 0 0 {name=l25 lab=GND}
C {tia_post_approval/schem/mirror_1.sym} 640 -390 0 0 {name=x5}
C {devices/lab_wire.sym} 490 -390 0 0 {name=l19 sig_type=std_logic lab=Vb1_}
C {devices/ngspice_probe.sym} 860 -410 0 0 {name=r2}
