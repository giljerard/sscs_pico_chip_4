...
C {devices/gnd.sym} 390 -100 3 0 {name=l22 lab=GND}
...
C {sky130_fd_pr/nfet_01v8.sym} 410 -50 0 1 {name=M1
L=.5
W=5
nf=1
mult=1
...
C {devices/gnd.sym} 430 -50 3 0 {name=l14 lab=GND}
C {devices/gnd.sym} 390 -20 0 0 {name=l26 lab=GND}
C {sky130_fd_pr/nfet_01v8.sym} 410 -280 0 1 {name=M2
L=.5
W=5
nf=1
mult=1
...
C {devices/gnd.sym} 390 -250 0 0 {name=l27 lab=GND}
C {devices/gnd.sym} 430 -280 3 0 {name=l28 lab=GND}
C {devices/gnd.sym} 390 -310 2 0 {name=l29 lab=GND}
