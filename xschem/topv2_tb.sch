...
N 280 -610 310 -610 { lab=Vb1-}
N 200 -530 220 -530 { lab=VDD}
N 280 -530 310 -530 { lab=Vb3-}
N 200 -450 220 -450 { lab=VDD}
N 280 -450 310 -450 { lab=Vb4-}
...
*value=1.8
value="pulse(0,1.8,0,1m,1n,100,200)"}
...
"}
C {devices/launcher.sym} 500 -480 0 0 {name=h1
descr='tate
tclcommand="ngspice::annotate"}
C {devices/ngspice_probe.sym} 450 -810 0 0 {name=r1}
C {devices/ammeter.sym} 450 -860 2 0 {name=Vmeas current=2.0981e-28}
...
*value=".75"
value="pulse(0,.75,0,1m,1n,100,200)"}
...
*value="1.3"
value="pulse(0,1.3,0,1m,1n,100,200)"}
...
C {sscs_pico_chip_4/xschem/top.sym} 890 -320 0 0 {name=x1}
...
C {devices/lab_wire.sym} 310 -610 0 1 {name=l12 sig_type=std_logic lab=Vb1-}
C {devices/lab_wire.sym} 310 -530 0 1 {name=l14 sig_type=std_logic lab=Vb3-}
C {devices/lab_wire.sym} 310 -450 0 1 {name=l15 sig_type=std_logic lab=Vb4-}
...
C {devices/ngspice_probe.sym} 1070 -350 0 0 {name=r4}
C {devices/ngspice_probe.sym} 1070 -290 0 0 {name=r5}
...
C {devices/ngspice_get_value.sym} 880 -60 0 1 {name=r9 node=v(x1.vcm2)
descr="Vcm2="}
C {sscs_pico_chip_4/xschem/big_cap.sym} 1460 -330 0 0 {name=x2}
C {devices/gnd.sym} 1460 -310 0 0 {name=l22 lab=GND}
C {devices/lab_wire.sym} 1460 -370 0 1 {name=l23 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 770 -870 0 0 {name=l24 sig_type=std_logic lab=Vb5-}
C {sscs_pico_chip_4/xschem/esd.sym} 770 -870 0 0 {name=x3}
C {devices/lab_pin.sym} 920 -850 2 0 {name=l25 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 920 -890 2 0 {name=l26 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 920 -870 2 0 {name=l27 sig_type=std_logic lab=Vb5}
C {devices/lab_pin.sym} 770 -800 0 0 {name=l28 sig_type=std_logic lab=Vb4-}
C {sscs_pico_chip_4/xschem/esd.sym} 770 -800 0 0 {name=x4}
C {devices/lab_pin.sym} 920 -780 2 0 {name=l29 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 920 -820 2 0 {name=l30 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 920 -800 2 0 {name=l31 sig_type=std_logic lab=Vb4_}
C {devices/lab_pin.sym} 770 -730 0 0 {name=l33 sig_type=std_logic lab=Vb3-}
C {sscs_pico_chip_4/xschem/esd.sym} 770 -730 0 0 {name=x5}
C {devices/lab_pin.sym} 920 -710 2 0 {name=l34 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 920 -750 2 0 {name=l35 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 920 -730 2 0 {name=l36 sig_type=std_logic lab=Vb3_}
C {devices/lab_pin.sym} 770 -660 0 0 {name=l37 sig_type=std_logic lab=Vb2-}
C {sscs_pico_chip_4/xschem/esd.sym} 770 -660 0 0 {name=x6}
C {devices/lab_pin.sym} 920 -640 2 0 {name=l38 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 920 -680 2 0 {name=l39 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 920 -660 2 0 {name=l40 sig_type=std_logic lab=Vb2}
C {devices/lab_pin.sym} 770 -590 0 0 {name=l42 sig_type=std_logic lab=Vb1-}
C {sscs_pico_chip_4/xschem/esd.sym} 770 -590 0 0 {name=x7}
C {devices/lab_pin.sym} 920 -570 2 0 {name=l43 sig_type=std_logic lab=GND}
C {devices/lab_pin.sym} 920 -610 2 0 {name=l44 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 920 -590 2 0 {name=l45 sig_type=std_logic lab=Vb1_}
