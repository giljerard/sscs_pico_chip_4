...
N 590 -310 590 -290 { lab=Vin_n}
N 590 -310 650 -310 { lab=Vin_n}
N 390 -120 390 -80 { lab=GND}
N 590 -140 590 -100 { lab=GND}
N 390 -240 390 -180 { lab=Vin_p}
N 590 -260 590 -200 { lab=Vin_n}
N 390 -270 390 -240 { lab=Vin_p}
N 590 -290 590 -260 { lab=Vin_n}
N 1020 -350 1190 -350 { lab=Vout_p}
N 1020 -310 1190 -310 { lab=Vout_n}
N 650 -310 740 -310 { lab=Vin_n}
N 390 -350 390 -270 { lab=Vin_p}
N 390 -350 740 -350 { lab=Vin_p}
N 1140 -370 1140 -350 { lab=Vout_p}
N 1140 -310 1140 -290 { lab=Vout_n}
N 830 -860 850 -860 { lab=VDD}
N 910 -860 940 -860 { lab=Vb4_}
N 1070 -700 1120 -700 { lab=Vb4}
...
.include /home/jared/Documents/GS_Design/tia_post_approval/pex/sf_pex_fixed.spice
"}
C {devices/launcher.sym} 600 -580 0 0 {name=h1
descr='tate
tclcommand="ngspice::annotate"}
C {devices/ngspice_probe.sym} 450 -810 0 0 {name=r1}
C {devices/ammeter.sym} 450 -860 2 0 {name=Vmeas current=0.01626}
...
.endc
"}
C {devices/gnd.sym} 590 -100 0 0 {name=l18 lab=GND}
C {devices/lab_wire.sym} 1190 -350 0 1 {name=l73 sig_type=std_logic lab=Vout_p}
C {devices/lab_wire.sym} 1190 -310 0 1 {name=l32 sig_type=std_logic lab=Vout_n}
C {devices/gnd.sym} 860 -270 0 0 {name=l16 lab=GND}
C {devices/lab_wire.sym} 840 -390 3 1 {name=l17 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 910 -390 3 1 {name=l6 sig_type=std_logic lab=Vb4}
C {devices/capa.sym} 1140 -400 0 0 {name=C6
m=1
value=50f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 1140 -430 2 0 {name=l80 lab=GND}
C {devices/capa.sym} 1140 -260 2 1 {name=C1
m=1
value=50f
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 1140 -230 0 1 {name=l10 lab=GND}
C {devices/vsource.sym} 390 -150 0 0 {name=VINP_source
value="sin(1.306,50n,1k) ac 1 0"
*value="sin(0,50n,1k)"
*value="pulse(0,450n,1n,0,0,1,10) ac 1 0"}
C {devices/vsource.sym} 590 -170 0 0 {name=VINN_source
*value="sin(0,-50n,1k) ac 1 0"
value="sin(1.306,-50n,1k)"
*value="pulse(0,-450n,1n,0,0,1,10) ac 1 0"}
C {devices/ngspice_probe.sym} 1080 -350 0 0 {name=r2}
C {devices/ngspice_probe.sym} 1080 -310 0 0 {name=r3}
C {devices/lab_wire.sym} 660 -350 0 1 {name=l9 sig_type=std_logic lab=Vin_p}
C {devices/lab_wire.sym} 660 -310 0 1 {name=l24 sig_type=std_logic lab=Vin_n}
C {tia_post_approval/schem/sf.sym} 740 -330 0 0 {name=X1}
C {devices/res_ac.sym} 880 -860 3 0 {name=R1
value=26k
ac=26k
m=1}
C {devices/lab_wire.sym} 830 -860 3 1 {name=l8 sig_type=std_logic lab=VDD}
C {devices/lab_wire.sym} 940 -860 0 1 {name=l12 sig_type=std_logic lab=Vb4_}
C {devices/gnd.sym} 1070 -660 0 0 {name=l42 lab=GND}
C {tia_post_approval/schem/mirror_4.sym} 920 -680 0 0 {name=x7}
C {devices/lab_wire.sym} 1120 -700 0 1 {name=l43 sig_type=std_logic lab=Vb4}
C {devices/ngspice_probe.sym} 1080 -700 0 0 {name=r4}
C {devices/lab_wire.sym} 770 -680 0 0 {name=l31 sig_type=std_logic lab=Vb4_}
