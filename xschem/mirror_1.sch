...
N 480 -150 480 -100 { lab=Vb1_}
N 580 -150 580 -100 { lab=Vb1}
...
C {devices/gnd.sym} 430 -270 3 0 {name=l14 lab=GND}
C {devices/gnd.sym} 390 -300 2 0 {name=l26 lab=GND}
C {devices/gnd.sym} 390 -270 1 0 {name=l27 lab=GND}
C {sky130_fd_pr/nfet_01v8.sym} 410 -50 0 1 {name=M2
L=.5
W=3.6
nf=1
mult=1
...
C {devices/gnd.sym} 430 -50 3 0 {name=l22 lab=GND}
